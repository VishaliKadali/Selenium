...
public class AutoSuggestions {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement button=driver.findElement(By.xpath("//button[contains(text(),'No thanks')]"));
		...
		/*
		 * driver.findElement(By.xpath("//input[@title='Search']")).sendKeys("Australia"
		 * ); driver.findElement(By.xpath("//input[@title='Search']")).sendKeys(Keys.
		 * ARROW_DOWN);
		 ...
		 * auto=driver.findElements(By.xpath("//ul[@class='G43f7e']/li")); WebDriverWait
		 * wait=new WebDriverWait(driver,Duration.ofSeconds(10));
		 * //wait.until(ExpectedConditions.visibilityOfAllElements(auto));
		 * 
		 * int count=auto.size(); System.out.println(count); auto.get(count-1).click();
		 */
		Thread.sleep(500);
		driver.findElement(By.xpath("//textarea[@class='gLFyf']")).sendKeys("Australia");
